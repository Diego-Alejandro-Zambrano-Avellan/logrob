                        ...
                        <div class="inline-block min-w-full py-2 align-middle">
                            <table class="w-full divide-y divide-gray-300">
                                ...
                                <tr>
									...
									<th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Coment</th>
                                ...
                                @foreach ($posts as $post)
                                    <tr class="even:bg-gray-50" wire:key="{{ $post->id }}">
										...
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $post->coment }}</td>
